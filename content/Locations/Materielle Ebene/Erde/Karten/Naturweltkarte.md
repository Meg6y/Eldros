...
//Markericons:
	...
	var MischwaldIcon = new L.Icon({
	    iconUrl: '/00Imagefolder/IconsMap/Mischwald.png',
	    iconSize: [30, 30],
	    iconAnchor: [15, 15],
	    popupAnchor: [-3, -38]
	});
	var OceanIcon = new L.Icon({
	    iconUrl: '/00Imagefolder/IconsMap/Ocean.png',
	    iconSize: [30, 30],
	    iconAnchor: [15, 15],
	    popupAnchor: [-3, -38]
	});
	var RegenwaldIcon = new L.Icon({
	    iconUrl: '/00Imagefolder/IconsMap/Regenwald.png',
	    iconSize: [30, 30],
	    iconAnchor: [15, 15],
	    popupAnchor: [-3, -38]
	});
	var SavanneIcon = new L.Icon({
	    iconUrl: '/00Imagefolder/IconsMap/Savanne.png',
	    iconSize: [30, 30],
	    iconAnchor: [15, 15],
	    popupAnchor: [-3, -38]
	});
	var WüsteIcon = new L.Icon({
	    iconUrl: '/00Imagefolder/IconsMap/Wüste.png',
	    iconSize: [30, 30],
	    iconAnchor: [15, 15],
	    popupAnchor: [-3, -38]
	});
